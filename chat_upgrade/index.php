...
$(document).on('click', '.reply-btn', function() {
    ...
    console.log('Reply to message ID:', messageId);
    console.log('Replying to message content:', messageContent);
    ...
    <div class="reply-content" style="display: flex; align-items: center;">
        ...
        <button class="cancel-reply" style=" padding: 5px; cursor: pointer;margin-buttom: 40px;">X</button>
    </div>
`;
    ...
    $('.reply-message').off('click'); // Clear any existing click event on the cancel button
});
